...
- Managed multiple, interconnected computational projects across different teams.
...
*** LeSS                                                             :ignore:
    ...
    - Compare knowledge graphs using
...
{{{cvevent(Knowtator: Concept and relation annotation plugin for Protégé,,,)}}}
